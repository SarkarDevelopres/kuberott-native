...
const TamilMovieScreen = () => {
  ...
  const fetchActionMovies = async () => {
    try {
      ...
      let req = await fetch(`${BASE_URL}/api/movie/getMovieListByLanguage?language=Tamil`);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.title}>Tamil Movies</Text>
      <FlatList
        data={actionMovies}
...
export default TamilMovieScreen;
